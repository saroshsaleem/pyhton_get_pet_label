...
def get_pet_labels(image_dir):
    ...
    #filename_end_list=list()
    #filename_no_dot=list()
...
# Prints resulting pet_name
  ...
  #  results_dic = {'pet_images/Boston_terrier_02303.jpg': ['boston terrier']} 
   # classify_images(None, results_dic, 'vgg') 
